(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/network/PacketID.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '92543tm4CxAKoOtKKrY/62r', 'PacketID', __filename);
// Script/network/PacketID.ts
...
//登陆
var PacketID = /** @class */ (function () {
    function PacketID() {
    }
    PacketID.prototype.WX_ThreeKingFun_qin004fgggff = function () {
        var aaa = 1;
        var bbb = 2;
        var ccc = 3;
    ...
    PacketID.prototype.WX_ThreeKingFun_qin004fgggff33 = function () {
        var aaa = 1;
        var bbb = 2;
        var ccc = 3;
        cc.log("aaa + bbb = ", aaa + bbb);
    ...
    PacketID.prototype.WX_ThreeKingFun_qin004fgggfrrf = function () {
        var aaa = 1;
        var bbb = 2;
        var ccc = 3;
        cc.log("aaa + bbb = ", aaa + bbb);
    ...
    PacketID.prototype.WX_ThreeKingFun_qin004fgggfggf = function () {
        var aaa = 1;
        var bbb = 2;
        var ccc = 3;
        cc.log("aaa + bbb = ", aaa + bbb);
    ...
    PacketID.prototype.WX_ThreeKingFun_qin004fggwwgff = function () {
        var aaa = 1;
        var bbb = 2;
        var ccc = 3;
        cc.log("aaa + bbb = ", aaa + bbb);
    ...
    PacketID.GetInt = function (value) {
        var su = parseInt(PacketID.transform(value), 2);
        return parseInt(PacketID.transform(value), 2);
    };
    //十六进制转换成有符号十进制方法
    PacketID.transform = function (i) {
    ...
    PacketID.prototype.WX_ThreeKingFun_qin004fgggffqq = function () {
        var aaa = 1;
        var bbb = 2;
        var ccc = 3;
        cc.log("aaa + bbb = ", aaa + bbb);
    ...
    //登录
    PacketID._SINA_PACKET_CS_Login_ID = BASIC_ID + 1;
    PacketID._SINA_PACKET_SC_Login_ID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_Login_ID).toString(16));
    //进入游戏
    PacketID._SINA_PACKET_CS_EnterGameID = (BASIC_ID) + 3;
    PacketID._SINA_PACKET_SC_EnterGameID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_EnterGameID).toString(16));
    //大厅游戏列表
    PacketID._SINA_PACKET_CS_GAMELISTID = BASIC_ID + 112;
    PacketID._SINA_PACKET_SC_GAMELISTIDRETID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_GAMELISTID).toString(16));
    //积分
    PacketID._SINA_PACKET_CS_CREDIT = BASIC_ID + 269;
    PacketID._SINA_PACKET_SC_CREDIT = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_CREDIT).toString(16));
    //下线通知
    PacketID._SINA_PACKET_SC_UserOfflineID = PacketID.GetInt((ACK + (BASIC_ID + 4)).toString(16));
    //(bit.bor(flag,BASIC_ID+4))
    //心跳
    PacketID._SINA_PACKET_CS_HeartBeatID = BASIC_ID + 5;
    PacketID._SINA_PACKET_SC_HeartBeatID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_HeartBeatID).toString(16));
    //服务器维护踢人下线
    PacketID._SINA_PACKET_SC_CutLineID = PacketID.GetInt((ACK + (BASIC_ID + 63)).toString(16));
    //判断用户是否在线通知
    PacketID._SINA_PACKET_SC_NoticePlayersOnlineRetID = PacketID.GetInt((ACK + (BASIC_ID + 115)).toString(16));
    //签到
    PacketID.BASIC_SIGN_IN = BASIC_ID + 28;
    PacketID.BASIC_SIGN_IN_ACK = PacketID.GetInt((ACK + PacketID.BASIC_SIGN_IN).toString(16));
    //签到初始化
    PacketID.BASIC_SIGN_INFO = BASIC_ID + 27;
    PacketID.BASIC_SIGN_INFO_ACK = PacketID.GetInt((ACK + PacketID.BASIC_SIGN_INFO).toString(16));
    //救济金
    PacketID._SINA_PACKET_CS_RESCUES_INFO_ID = BASIC_ID + 33;
    PacketID._SINA_PACKET_SC_RESCUES_INFO_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_RESCUES_INFO_ID).toString(16));
    PacketID._SINA_PACKET_CS_RESCUES_GOIN_ID = BASIC_ID + 34;
    PacketID._SINA_PACKET_SC_RESCUES_GOIN_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_RESCUES_GOIN_ID).toString(16));
    //广播推送  走马灯
    PacketID._SINA_PACKET_CS_RotateNoticeID = BASIC_ID + 51;
    PacketID._SINA_PACKET_SC_RotateNoticeID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_RotateNoticeID).toString(16));
    //看微博视频广告进游戏
    PacketID._SINA_PACKET_CS_ENTER_GAME_ADVERT_ID = BASIC_ID + 267;
    PacketID._SINA_PACKET_SC_ENTER_GAME_ADVERT_ID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_ENTER_GAME_ADVERT_ID).toString(16));
    //最新love的游戏
    PacketID._SINA_PACKET_CS_MINI_LOVE_GAME_ID = BASIC_ID + 268;
    PacketID._SINA_PACKET_SC_MINI_LOVE_GAME_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_MINI_LOVE_GAME_ID).toString(16));
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////-
    //单机小游戏
    //单机游戏开始
    PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_START_ID = BASIC_ID + 222;
    PacketID._SINA_PACKET_SC_BASIC_SINGLE_GAME_START_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_START_ID).toString(16));
    //单机游戏数据同步
    PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_SYN_ID = BASIC_ID + 223;
    PacketID._SINA_PACKET_SC_BASIC_SINGLE_GAME_SYN_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_SYN_ID).toString(16));
    //购买复活
    PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_LIFE_ID = BASIC_ID + 224;
    PacketID._SINA_PACKET_SC_BASIC_SINGLE_GAME_LIFE_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_LIFE_ID).toString(16));
    //排行榜
    PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_ORDER_ID = BASIC_ID + 225;
    PacketID._SINA_PACKET_SC_BASIC_SINGLE_GAME_ORDER_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_ORDER_ID).toString(16));
    //获取大转盘信息
    PacketID._SINA_PACKET_CS_BASIC_BIGWHEEL_INFO = BASIC_ID + 226;
    PacketID._SINA_PACKET_SC_BASIC_BIGWHEEL_INFO_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_BIGWHEEL_INFO).toString(16));
    //摇中大转盘
    PacketID._SINA_PACKET_CS_BASIC_BIGWHEEL_GAIN = BASIC_ID + 227;
    PacketID._SINA_PACKET_SC_BASIC_BIGWHEEL_GAIN_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_BIGWHEEL_GAIN).toString(16));
    //排行榜
    PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_SEND_ID = BASIC_ID + 228;
    PacketID._SINA_PACKET_SC_BASIC_SINGLE_GAME_SEND_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_SEND_ID).toString(16));
    //进入武器库界面初始化数据
    PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_SKIN_ID = BASIC_ID + 244;
    PacketID._SINA_PACKET_SC_BASIC_SINGLE_GAME_SKIN_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_SKIN_ID).toString(16));
    //获得武器同步
    PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_LOTTERY_ID = BASIC_ID + 245;
    PacketID._SINA_PACKET_SC_BASIC_SINGLE_GAME_LOTTERY_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_LOTTERY_ID).toString(16));
    //更换武器
    PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_EXCHANGE_ID = BASIC_ID + 246;
    PacketID._SINA_PACKET_SC_BASIC_SINGLE_GAME_EXCHANGE_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_EXCHANGE_ID).toString(16));
    //签到
    PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_CHECKIN_ID = BASIC_ID + 242;
    PacketID._SINA_PACKET_SC_BASIC_SINGLE_GAME_CHECKIN_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_CHECKIN_ID).toString(16));
    //签到信息
    PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_CHECKDAY_ID = BASIC_ID + 243;
    PacketID._SINA_PACKET_SC_BASIC_SINGLE_GAME_CHECKDAY_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_CHECKDAY_ID).toString(16));
    //离线奖励点击翻倍
    PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_OFFLINE_DOUBLE_ID = BASIC_ID + 248;
    PacketID._SINA_PACKET_SC_BASIC_SINGLE_GAME_OFFLINE_DOUBLE_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_OFFLINE_DOUBLE_ID).toString(16));
    //离线奖励
    PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_OFFLINE_ID = BASIC_ID + 250;
    PacketID._SINA_PACKET_SC_BASIC_SINGLE_GAME_OFFLINE_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_OFFLINE_ID).toString(16));
    //领取离线奖励
    PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_OFFLINE_CLICK_ID = BASIC_ID + 251;
    PacketID._SINA_PACKET_SC_BASIC_SINGLE_GAME_OFFLINE_CLICK_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_OFFLINE_CLICK_ID).toString(16));
    //关卡奖励
    PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_LEVEL_REWARD_ID = BASIC_ID + 252;
    PacketID._SINA_PACKET_SC_BASIC_SINGLE_GAME_LEVEL_REWARD_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_LEVEL_REWARD_ID).toString(16));
    //邀请绑定
    PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_INVITE_BIND_ID = BASIC_ID + 253;
    PacketID._SINA_PACKET_SC_BASIC_SINGLE_GAME_INVITE_BIND_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_INVITE_BIND_ID).toString(16));
    //邀请好友领取界面
    PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_INVITE_INFO_ID = BASIC_ID + 254;
    PacketID._SINA_PACKET_SC_BASIC_SINGLE_GAME_INVITE_INFO_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_INVITE_INFO_ID).toString(16));
    //点击领取
    PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_INVITE_DRAW_ID = BASIC_ID + 255;
    PacketID._SINA_PACKET_SC_BASIC_SINGLE_GAME_INVITE_DRAW_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_INVITE_DRAW_ID).toString(16));
    //微信用户信息
    PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_WX_USERINFO_ID = BASIC_ID + 256;
    PacketID._SINA_PACKET_SC_BASIC_SINGLE_GAME_WX_USERINFO_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_WX_USERINFO_ID).toString(16));
    //兑换钻石
    PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_GEM_EXCHANGE_INFO_ID = BASIC_ID + 265;
    PacketID._SINA_PACKET_SC_BASIC_SINGLE_GAME_GEM_EXCHANGE_INFO_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_GEM_EXCHANGE_INFO_ID).toString(16));
    //兑换钻石
    PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_GEM_EXCHANGE_ID = BASIC_ID + 266;
    PacketID._SINA_PACKET_SC_BASIC_SINGLE_GAME_GEM_EXCHANGE_RetID = PacketID.GetInt((ACK + PacketID._SINA_PACKET_CS_BASIC_SINGLE_GAME_GEM_EXCHANGE_ID).toString(16));
    return PacketID;
}());
